...
class __TwigTemplate_1e32289b9215c1b2cee4182e808b5c84 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ((isset($context["contacto"]) || array_key_exists("contacto", $context) ? $context["contacto"] : (function () { throw new RuntimeError('Variable "contacto" does not exist.', 6, $this->source); })())) {
            // line 7
            echo "        ";
            echo twig_include($this->env, $context, "datos_contacto.html.twig", ["contacto" => (isset($context["contacto"]) || array_key_exists("contacto", $context) ? $context["contacto"] : (function () { throw new RuntimeError('Variable "contacto" does not exist.', 7, $this->source); })())]);
            echo "
    ";
        } else {
            // line 9
...
{% block body %}
    ...
    {% endif %}
{% endblock %}", "ficha_contacto.html.twig", "/home/alumno/primeros-pasos/templates/ficha_contacto.html.twig");
    }
}
